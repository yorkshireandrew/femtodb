...
public class ByteFilterEQ implements FemtoDBIterator{
	private int 			column;
	...
	ByteFilterEQ(final int column, final byte compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
