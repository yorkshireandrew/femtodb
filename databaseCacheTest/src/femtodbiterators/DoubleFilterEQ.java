...
public class DoubleFilterEQ implements FemtoDBIterator{
	private int 			column;
	...
	DoubleFilterEQ(final int column, final double compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
