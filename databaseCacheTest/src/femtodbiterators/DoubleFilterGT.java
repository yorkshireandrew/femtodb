...
public class DoubleFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	DoubleFilterGT(final int column, final double compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
