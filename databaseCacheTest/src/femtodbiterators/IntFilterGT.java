...
public class IntFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	IntFilterGT(final int column, final int compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
