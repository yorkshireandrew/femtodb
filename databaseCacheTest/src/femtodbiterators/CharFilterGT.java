...
public class CharFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	CharFilterGT(final int column, final char compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
