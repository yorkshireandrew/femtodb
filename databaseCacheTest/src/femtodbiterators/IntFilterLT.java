...
public class IntFilterLT implements FemtoDBIterator{
	private int 			column;
	...
	IntFilterLT(final int column, final int compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
