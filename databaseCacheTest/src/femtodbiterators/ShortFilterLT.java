...
public class ShortFilterLT implements FemtoDBIterator{
	private int 			column;
	...
	ShortFilterLT(final int column, final short compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
