...
public class StringFilterEQ implements FemtoDBIterator{
	private int 			column;
	...
	StringFilterEQ(final int column, final String compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
