...
public class CopyOfStringFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	CopyOfStringFilterGT(final int column, final String compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
	...
	public boolean hasNext() throws FemtoDBConcurrentModificationException,FemtoDBIOException {
		...
		while(true)
		{
			...
			if(temp.getString(columnL).equals(compareValueL))
			{
