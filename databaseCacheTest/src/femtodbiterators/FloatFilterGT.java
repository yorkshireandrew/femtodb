...
public class FloatFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	FloatFilterGT(final int column, final float compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
