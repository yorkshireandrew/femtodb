...
public class LongFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	LongFilterGT(final int column, final long compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
