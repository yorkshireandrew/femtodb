...
public class ByteFilterLT implements FemtoDBIterator{
	private int 			column;
	...
	ByteFilterLT(final int column, final byte compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
