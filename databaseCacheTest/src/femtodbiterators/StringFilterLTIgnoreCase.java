...
public class StringFilterLTIgnoreCase implements FemtoDBIterator{
	private int 			column;
	private String 			compareValue;
	private FemtoDBIterator source;
	private RowAccessType	currentRow;
	
	StringFilterLTIgnoreCase(final int column, final String compareValue, final FemtoDBIterator source)
	{
		this.column 		= column;
