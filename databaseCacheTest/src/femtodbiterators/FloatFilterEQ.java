...
public class FloatFilterEQ implements FemtoDBIterator{
	private int 			column;
	...
	FloatFilterEQ(final int column, final float compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
