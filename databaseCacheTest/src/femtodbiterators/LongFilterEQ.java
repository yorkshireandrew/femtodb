...
public class LongFilterEQ implements FemtoDBIterator{
	private int 			column;
	...
	LongFilterEQ(final int column, final long compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
