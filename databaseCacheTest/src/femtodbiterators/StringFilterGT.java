...
public class StringFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	StringFilterGT(final int column, final String compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
