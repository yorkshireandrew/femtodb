...
public class CharFilterEQ implements FemtoDBIterator{
	private int 			column;
	...
	CharFilterEQ(final int column, final char compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
