...
public class ShortFilterGT implements FemtoDBIterator{
	private int 			column;
	...
	ShortFilterGT(final int column, final short compareValue, final FemtoDBIterator source, final boolean invert)
	{
		this.column 		= column;
